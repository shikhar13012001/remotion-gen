...
/**
 * REIT (Real Estate Investment Trust) Guide Composition
 * Maps 17 sentences to appropriate scene templates based on beat + content
 * Uses design tokens for all styling (no hardcoded colors/fonts/spacing)
 */
export const ReitComposition: React.FC<Props> = ({
  scenes,
  sentenceDurations,
  suggestedDurations,
  resolvedImages,
