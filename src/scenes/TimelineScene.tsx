...
export const TimelineScene: React.FC<TimelineSceneProps> = ({
  events, accent, wordTimings, sentenceIndex,
  ...
  // Build AnimationSpec compatible with existing timeline component
  const spec = {
    type:            "timeline" as const,
    data:            {
      events:    events.map(e => ({ date: e.time, label: e.event, sublabel: e.detail })),
  ...
  const AnimComponent = ANIMATION_REGISTRY["timeline"] ?? null;
